// waits for all scripts to load before running functions
        ...
        switch (selectedRadioButton.value){
            ...
            case 'search':
                ...
                if(searchResults.length > 0){
                    ...
                    resultsElement.innerText = "No matching emojios found."
                }
                break;
            case 'random':
                //For random, select a random ttranslation and execute that functionality
